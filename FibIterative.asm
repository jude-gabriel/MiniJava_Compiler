...
# ****** class Main ****** # ClassDecl at 4.7
 .byte 205 # 'M' with high bit set # IdentifierType at 4.7
 .byte 97 # 'a' # IdentifierType at 4.7
 .byte 105 # 'i' # IdentifierType at 4.7
 .byte 110 # 'n' # IdentifierType at 4.7
CLASS_Main: # ClassDecl at 4.7
 .word hashCode_Object # ClassDecl at 4.7
 .word equals_Object # ClassDecl at 4.7
 .word toString_Object # ClassDecl at 4.7
 .word fcn_35_main # ClassDecl at 4.7
 .word fcn_76_fib # ClassDecl at 4.7
...
strLit_32: # StringLiteral at 23.15
 .text # Program at 4.1; stackHeight = 0
  # ENTER NODE # Program at 4.1; stackHeight = 0
   .globl main # Program at 4.1; stackHeight = 0
  main: # Program at 4.1; stackHeight = 0
   jal vm_init # Program at 4.1; stackHeight = 0
   ...
   li $v0,10 # Program at 4.1; stackHeight = 0
   syscall # Program at 4.1; stackHeight = 0
  # EXIT NODE # Program at 4.1; stackHeight = 0
  # ENTER NODE # ClassDecl at 4.7; stackHeight = 0
  # **** class Main **** # ClassDecl at 4.7; stackHeight = 0
    # ENTER NODE # MethodDeclVoid at 7.17; stackHeight = 0
    .globl fcn_35_main # MethodDeclVoid at 7.17; stackHeight = 0
    fcn_35_main: # MethodDeclVoid at 7.17; stackHeight = 0
     subu $sp,$sp,4 # MethodDeclVoid at 7.17; stackHeight = 0
     sw $s2,($sp) #**"old this-ptr" # MethodDeclVoid at 7.17; stackHeight = 0
     lw $s2,4($sp) #**"this-ptr" # MethodDeclVoid at 7.17; stackHeight = 0
     sw $ra,4($sp) #**"RA:main" # MethodDeclVoid at 7.17; stackHeight = 0
      # ENTER NODE # LocalVarDecl at 10.6; stackHeight = 0
        # ENTER NODE # NewObject at 10.12; stackHeight = 0
         li $s6,1 # NewObject at 10.12; stackHeight = 0
         li $s7,0 # NewObject at 10.12; stackHeight = 0
         jal newObject # NewObject at 10.12; stackHeight = 0
         la $t0,CLASS_Lib # NewObject at 10.12; stackHeight = 4
         sw $t0,-12($s7)#**"VTP: Lib" # NewObject at 10.12; stackHeight = 4
        # EXIT NODE # NewObject at 10.12; stackHeight = 4
      # EXIT NODE # LocalVarDecl at 10.6; stackHeight = 4
      # ENTER NODE # LocalVarDecl at 13.6; stackHeight = 4
        # ENTER NODE # IntegerLiteral at 13.12; stackHeight = 4
         subu $sp,$sp,8 # IntegerLiteral at 13.12; stackHeight = 4
         sw $s5,4($sp)#**"GC tag" # IntegerLiteral at 13.12; stackHeight = 12
         li $t0,14 # IntegerLiteral at 13.12; stackHeight = 12
         sw $t0,($sp) # IntegerLiteral at 13.12; stackHeight = 12
        # EXIT NODE # IntegerLiteral at 13.12; stackHeight = 12
      # EXIT NODE # LocalVarDecl at 13.6; stackHeight = 12
      # ENTER NODE # LocalVarDecl at 16.6; stackHeight = 12
        # ENTER NODE # Call at 16.15; stackHeight = 12
          # ENTER NODE # This at 16.15; stackHeight = 12
           subu $sp,$sp,4 # This at 16.15; stackHeight = 12
           sw $s2,($sp)#**"" # This at 16.15; stackHeight = 16
          # EXIT NODE # This at 16.15; stackHeight = 16
          # ENTER NODE # IdentifierExp at 16.19; stackHeight = 16
           lw $t0,4($sp) # local: stackHt=16,var-offset=-12 # IdentifierExp at 16.19; stackHeight = 16
           subu $sp,$sp,8 # IdentifierExp at 16.19; stackHeight = 16
           sw $s5,4($sp)#**"GC tag" # IdentifierExp at 16.19; stackHeight = 24
           sw $t0,($sp)#**"" # IdentifierExp at 16.19; stackHeight = 24
          # EXIT NODE # IdentifierExp at 16.19; stackHeight = 24
         lw $t0,8($sp) # Call at 16.15; stackHeight = 24
         beq $t0,$zero,nullPtrException # Call at 16.15; stackHeight = 24
         lw $t0,-12($t0) # Call at 16.15; stackHeight = 24
         lw $t0,16($t0) # Call at 16.15; stackHeight = 24
         jalr $t0 # fib # Call at 16.15; stackHeight = 24
        # EXIT NODE # Call at 16.15; stackHeight = 20
      # EXIT NODE # LocalVarDecl at 16.6; stackHeight = 20
      # ENTER NODE # CallStatement at 19.6; stackHeight = 20
        # ENTER NODE # Call at 19.6; stackHeight = 20
          # ENTER NODE # IdentifierExp at 19.2; stackHeight = 20
           lw $t0,16($sp) # local: stackHt=20,var-offset=-4 # IdentifierExp at 19.2; stackHeight = 20
           subu $sp,$sp,4 # IdentifierExp at 19.2; stackHeight = 20
           sw $t0,($sp)#**"" # IdentifierExp at 19.2; stackHeight = 24
          # EXIT NODE # IdentifierExp at 19.2; stackHeight = 24
          # ENTER NODE # StringLiteral at 19.15; stackHeight = 24
           subu $sp,$sp,4 # StringLiteral at 19.15; stackHeight = 24
           la $t0,strLit_16 # StringLiteral at 19.15; stackHeight = 28
           sw $t0,($sp)#**"strLit:The fibonacci number of " # StringLiteral at 19.15; stackHeight = 28
          # EXIT NODE # StringLiteral at 19.15; stackHeight = 28
         lw $t0,4($sp) # Call at 19.6; stackHeight = 28
         beq $t0,$zero,nullPtrException # Call at 19.6; stackHeight = 28
         lw $t0,-12($t0) # Call at 19.6; stackHeight = 28
         lw $t0,24($t0) # Call at 19.6; stackHeight = 28
         jalr $t0 # printStr # Call at 19.6; stackHeight = 28
        # EXIT NODE # Call at 19.6; stackHeight = 20
      # EXIT NODE # CallStatement at 19.6; stackHeight = 20
      # ENTER NODE # CallStatement at 20.6; stackHeight = 20
        # ENTER NODE # Call at 20.6; stackHeight = 20
          # ENTER NODE # IdentifierExp at 20.2; stackHeight = 20
           lw $t0,16($sp) # local: stackHt=20,var-offset=-4 # IdentifierExp at 20.2; stackHeight = 20
           subu $sp,$sp,4 # IdentifierExp at 20.2; stackHeight = 20
           sw $t0,($sp)#**"" # IdentifierExp at 20.2; stackHeight = 24
          # EXIT NODE # IdentifierExp at 20.2; stackHeight = 24
          # ENTER NODE # IdentifierExp at 20.15; stackHeight = 24
           lw $t0,12($sp) # local: stackHt=24,var-offset=-12 # IdentifierExp at 20.15; stackHeight = 24
           subu $sp,$sp,8 # IdentifierExp at 20.15; stackHeight = 24
           sw $s5,4($sp)#**"GC tag" # IdentifierExp at 20.15; stackHeight = 32
           sw $t0,($sp)#**"" # IdentifierExp at 20.15; stackHeight = 32
          # EXIT NODE # IdentifierExp at 20.15; stackHeight = 32
         lw $t0,8($sp) # Call at 20.6; stackHeight = 32
         beq $t0,$zero,nullPtrException # Call at 20.6; stackHeight = 32
         lw $t0,-12($t0) # Call at 20.6; stackHeight = 32
         lw $t0,32($t0) # Call at 20.6; stackHeight = 32
         jalr $t0 # printInt # Call at 20.6; stackHeight = 32
      ...
      # ENTER NODE # CallStatement at 21.6; stackHeight = 20
        # ENTER NODE # Call at 21.6; stackHeight = 20
          # ENTER NODE # IdentifierExp at 21.2; stackHeight = 20
           lw $t0,16($sp) # local: stackHt=20,var-offset=-4 # IdentifierExp at 21.2; stackHeight = 20
           subu $sp,$sp,4 # IdentifierExp at 21.2; stackHeight = 20
           sw $t0,($sp)#**"" # IdentifierExp at 21.2; stackHeight = 24
          # EXIT NODE # IdentifierExp at 21.2; stackHeight = 24
          # ENTER NODE # StringLiteral at 21.15; stackHeight = 24
           subu $sp,$sp,4 # StringLiteral at 21.15; stackHeight = 24
           la $t0,strLit_24 # StringLiteral at 21.15; stackHeight = 28
           sw $t0,($sp)#**"strLit: is " # StringLiteral at 21.15; stackHeight = 28
          # EXIT NODE # StringLiteral at 21.15; stackHeight = 28
         lw $t0,4($sp) # Call at 21.6; stackHeight = 28
         beq $t0,$zero,nullPtrException # Call at 21.6; stackHeight = 28
         lw $t0,-12($t0) # Call at 21.6; stackHeight = 28
         lw $t0,24($t0) # Call at 21.6; stackHeight = 28
         jalr $t0 # printStr # Call at 21.6; stackHeight = 28
      ...
      # ENTER NODE # CallStatement at 22.6; stackHeight = 20
        # ENTER NODE # Call at 22.6; stackHeight = 20
          # ENTER NODE # IdentifierExp at 22.2; stackHeight = 20
           lw $t0,16($sp) # local: stackHt=20,var-offset=-4 # IdentifierExp at 22.2; stackHeight = 20
           subu $sp,$sp,4 # IdentifierExp at 22.2; stackHeight = 20
           sw $t0,($sp)#**"" # IdentifierExp at 22.2; stackHeight = 24
          # EXIT NODE # IdentifierExp at 22.2; stackHeight = 24
          # ENTER NODE # IdentifierExp at 22.15; stackHeight = 24
           lw $t0,4($sp) # local: stackHt=24,var-offset=-20 # IdentifierExp at 22.15; stackHeight = 24
           subu $sp,$sp,8 # IdentifierExp at 22.15; stackHeight = 24
           sw $s5,4($sp)#**"GC tag" # IdentifierExp at 22.15; stackHeight = 32
           sw $t0,($sp)#**"" # IdentifierExp at 22.15; stackHeight = 32
          # EXIT NODE # IdentifierExp at 22.15; stackHeight = 32
         lw $t0,8($sp) # Call at 22.6; stackHeight = 32
         beq $t0,$zero,nullPtrException # Call at 22.6; stackHeight = 32
         lw $t0,-12($t0) # Call at 22.6; stackHeight = 32
         lw $t0,32($t0) # Call at 22.6; stackHeight = 32
         jalr $t0 # printInt # Call at 22.6; stackHeight = 32
        # EXIT NODE # Call at 22.6; stackHeight = 20
      # EXIT NODE # CallStatement at 22.6; stackHeight = 20
      # ENTER NODE # CallStatement at 23.6; stackHeight = 20
        # ENTER NODE # Call at 23.6; stackHeight = 20
          # ENTER NODE # IdentifierExp at 23.2; stackHeight = 20
           lw $t0,16($sp) # local: stackHt=20,var-offset=-4 # IdentifierExp at 23.2; stackHeight = 20
           subu $sp,$sp,4 # IdentifierExp at 23.2; stackHeight = 20
           sw $t0,($sp)#**"" # IdentifierExp at 23.2; stackHeight = 24
          # EXIT NODE # IdentifierExp at 23.2; stackHeight = 24
          # ENTER NODE # StringLiteral at 23.15; stackHeight = 24
           subu $sp,$sp,4 # StringLiteral at 23.15; stackHeight = 24
           la $t0,strLit_32 # StringLiteral at 23.15; stackHeight = 28
           sw $t0,($sp)#**"strLit:.\?" # StringLiteral at 23.15; stackHeight = 28
          # EXIT NODE # StringLiteral at 23.15; stackHeight = 28
         lw $t0,4($sp) # Call at 23.6; stackHeight = 28
         beq $t0,$zero,nullPtrException # Call at 23.6; stackHeight = 28
         lw $t0,-12($t0) # Call at 23.6; stackHeight = 28
         lw $t0,24($t0) # Call at 23.6; stackHeight = 28
         jalr $t0 # printStr # Call at 23.6; stackHeight = 28
        # EXIT NODE # Call at 23.6; stackHeight = 20
      # EXIT NODE # CallStatement at 23.6; stackHeight = 20
     # stack height is 20 # MethodDeclVoid at 7.17; stackHeight = 20
     lw $ra,24($sp) # MethodDeclVoid at 7.17; stackHeight = 20
     lw $s2,20($sp) # MethodDeclVoid at 7.17; stackHeight = 20
     addu $sp,$sp,28 # MethodDeclVoid at 7.17; stackHeight = 20
    jr $ra # MethodDeclVoid at 7.17; stackHeight = -8
    # EXIT NODE # MethodDeclVoid at 7.17; stackHeight = -8
    # ENTER NODE # MethodDeclNonVoid at 28.16; stackHeight = -8
    .globl fcn_76_fib # MethodDeclNonVoid at 28.16; stackHeight = -8
    fcn_76_fib: # MethodDeclNonVoid at 28.16; stackHeight = -8
     subu $sp,$sp,4 # MethodDeclNonVoid at 28.16; stackHeight = -8
     sw $s2,($sp) #**"old this-ptr" # MethodDeclNonVoid at 28.16; stackHeight = -8
     lw $s2,12($sp) #**"this-ptr" # MethodDeclNonVoid at 28.16; stackHeight = -8
     sw $ra,12($sp) #**"RA:fib" # MethodDeclNonVoid at 28.16; stackHeight = -8
      # ENTER NODE # LocalVarDecl at 29.6; stackHeight = 0
        # ENTER NODE # IntegerLiteral at 29.13; stackHeight = 0
         subu $sp,$sp,8 # IntegerLiteral at 29.13; stackHeight = 0
         sw $s5,4($sp)#**"GC tag" # IntegerLiteral at 29.13; stackHeight = 8
         li $t0,1 # IntegerLiteral at 29.13; stackHeight = 8
         sw $t0,($sp) # IntegerLiteral at 29.13; stackHeight = 8
        # EXIT NODE # IntegerLiteral at 29.13; stackHeight = 8
      # EXIT NODE # LocalVarDecl at 29.6; stackHeight = 8
      # ENTER NODE # LocalVarDecl at 30.6; stackHeight = 8
        # ENTER NODE # IntegerLiteral at 30.16; stackHeight = 8
         subu $sp,$sp,8 # IntegerLiteral at 30.16; stackHeight = 8
         sw $s5,4($sp)#**"GC tag" # IntegerLiteral at 30.16; stackHeight = 16
         li $t0,0 # IntegerLiteral at 30.16; stackHeight = 16
         sw $t0,($sp) # IntegerLiteral at 30.16; stackHeight = 16
        # EXIT NODE # IntegerLiteral at 30.16; stackHeight = 16
      # EXIT NODE # LocalVarDecl at 30.6; stackHeight = 16
      # ENTER NODE # Block at 31.2; stackHeight = 16
        # ENTER NODE # LocalVarDecl at 31.11; stackHeight = 16
          # ENTER NODE # IntegerLiteral at 31.15; stackHeight = 16
           subu $sp,$sp,8 # IntegerLiteral at 31.15; stackHeight = 16
           sw $s5,4($sp)#**"GC tag" # IntegerLiteral at 31.15; stackHeight = 24
           li $t0,0 # IntegerLiteral at 31.15; stackHeight = 24
           sw $t0,($sp) # IntegerLiteral at 31.15; stackHeight = 24
          # EXIT NODE # IntegerLiteral at 31.15; stackHeight = 24
        # EXIT NODE # LocalVarDecl at 31.11; stackHeight = 24
        # ENTER NODE # While at 31.2; stackHeight = 24
        j while_enter_73 # While at 31.2; stackHeight = 24
        while_top_73: # While at 31.2; stackHeight = 24
          # ENTER NODE # Block at 31.2; stackHeight = 24
            # ENTER NODE # Block at 31.30; stackHeight = 24
              # ENTER NODE # LocalVarDecl at 32.10; stackHeight = 24
                # ENTER NODE # IdentifierExp at 32.17; stackHeight = 24
                 lw $t0,8($sp) # local: stackHt=24,var-offset=-16 # IdentifierExp at 32.17; stackHeight = 24
                 subu $sp,$sp,8 # IdentifierExp at 32.17; stackHeight = 24
                 sw $s5,4($sp)#**"GC tag" # IdentifierExp at 32.17; stackHeight = 32
                 sw $t0,($sp)#**"" # IdentifierExp at 32.17; stackHeight = 32
                # EXIT NODE # IdentifierExp at 32.17; stackHeight = 32
              # EXIT NODE # LocalVarDecl at 32.10; stackHeight = 32
              # ENTER NODE # Assign at 33.14; stackHeight = 32
                # ENTER NODE # Plus at 33.24; stackHeight = 32
                  # ENTER NODE # IdentifierExp at 33.16; stackHeight = 32
                   lw $t0,16($sp) # local: stackHt=32,var-offset=-16 # IdentifierExp at 33.16; stackHeight = 32
                   subu $sp,$sp,8 # IdentifierExp at 33.16; stackHeight = 32
                   sw $s5,4($sp)#**"GC tag" # IdentifierExp at 33.16; stackHeight = 40
                   sw $t0,($sp)#**"" # IdentifierExp at 33.16; stackHeight = 40
                  # EXIT NODE # IdentifierExp at 33.16; stackHeight = 40
                  # ENTER NODE # IdentifierExp at 33.26; stackHeight = 40
                   lw $t0,32($sp) # local: stackHt=40,var-offset=-8 # IdentifierExp at 33.26; stackHeight = 40
                   subu $sp,$sp,8 # IdentifierExp at 33.26; stackHeight = 40
                   sw $s5,4($sp)#**"GC tag" # IdentifierExp at 33.26; stackHeight = 48
                   sw $t0,($sp)#**"" # IdentifierExp at 33.26; stackHeight = 48
                  # EXIT NODE # IdentifierExp at 33.26; stackHeight = 48
                 lw $t0,($sp) # Plus at 33.24; stackHeight = 48
                 lw $t1,8($sp) # Plus at 33.24; stackHeight = 48
                 addu $t0,$t0,$t1 # Plus at 33.24; stackHeight = 48
                 addu $sp,$sp,8 # Plus at 33.24; stackHeight = 48
                 sw $t0,($sp)#**"" # Plus at 33.24; stackHeight = 48
                # EXIT NODE # Plus at 33.24; stackHeight = 40
               lw $t0,($sp) # Assign at 33.14; stackHeight = 40
               sw $t0,24($sp) # Assign at 33.14; stackHeight = 40
               addu $sp,$sp,8 # Assign at 33.14; stackHeight = 40
              # EXIT NODE # Assign at 33.14; stackHeight = 32
              # ENTER NODE # Assign at 34.11; stackHeight = 32
                # ENTER NODE # IdentifierExp at 34.13; stackHeight = 32
                 lw $t0,0($sp) # local: stackHt=32,var-offset=-32 # IdentifierExp at 34.13; stackHeight = 32
                 subu $sp,$sp,8 # IdentifierExp at 34.13; stackHeight = 32
                 sw $s5,4($sp)#**"GC tag" # IdentifierExp at 34.13; stackHeight = 40
                 sw $t0,($sp)#**"" # IdentifierExp at 34.13; stackHeight = 40
                # EXIT NODE # IdentifierExp at 34.13; stackHeight = 40
               lw $t0,($sp) # Assign at 34.11; stackHeight = 40
               sw $t0,32($sp) # Assign at 34.11; stackHeight = 40
               addu $sp,$sp,8 # Assign at 34.11; stackHeight = 40
              # EXIT NODE # Assign at 34.11; stackHeight = 32
             addu $sp,8 # Block at 31.30; stackHeight = 32
            # EXIT NODE # Block at 31.30; stackHeight = 24
            # ENTER NODE # Assign at 31.25; stackHeight = 24
              # ENTER NODE # Plus at 31.26; stackHeight = 24
                # ENTER NODE # IdentifierExp at 31.25; stackHeight = 24
                 lw $t0,0($sp) # local: stackHt=24,var-offset=-24 # IdentifierExp at 31.25; stackHeight = 24
                 subu $sp,$sp,8 # IdentifierExp at 31.25; stackHeight = 24
                 sw $s5,4($sp)#**"GC tag" # IdentifierExp at 31.25; stackHeight = 32
                 sw $t0,($sp)#**"" # IdentifierExp at 31.25; stackHeight = 32
                # EXIT NODE # IdentifierExp at 31.25; stackHeight = 32
                # ENTER NODE # IntegerLiteral at 31.26; stackHeight = 32
                 subu $sp,$sp,8 # IntegerLiteral at 31.26; stackHeight = 32
                 sw $s5,4($sp)#**"GC tag" # IntegerLiteral at 31.26; stackHeight = 40
                 li $t0,1 # IntegerLiteral at 31.26; stackHeight = 40
                 sw $t0,($sp) # IntegerLiteral at 31.26; stackHeight = 40
                # EXIT NODE # IntegerLiteral at 31.26; stackHeight = 40
               lw $t0,($sp) # Plus at 31.26; stackHeight = 40
               lw $t1,8($sp) # Plus at 31.26; stackHeight = 40
               addu $t0,$t0,$t1 # Plus at 31.26; stackHeight = 40
               addu $sp,$sp,8 # Plus at 31.26; stackHeight = 40
               sw $t0,($sp)#**"" # Plus at 31.26; stackHeight = 40
              # EXIT NODE # Plus at 31.26; stackHeight = 32
             lw $t0,($sp) # Assign at 31.25; stackHeight = 32
             sw $t0,8($sp) # Assign at 31.25; stackHeight = 32
             addu $sp,$sp,8 # Assign at 31.25; stackHeight = 32
            # EXIT NODE # Assign at 31.25; stackHeight = 24
          # EXIT NODE # Block at 31.2; stackHeight = 24
        while_enter_73: # While at 31.2; stackHeight = 24
          # ENTER NODE # LessThan at 31.20; stackHeight = 24
            # ENTER NODE # IdentifierExp at 31.18; stackHeight = 24
             lw $t0,0($sp) # local: stackHt=24,var-offset=-24 # IdentifierExp at 31.18; stackHeight = 24
             subu $sp,$sp,8 # IdentifierExp at 31.18; stackHeight = 24
             sw $s5,4($sp)#**"GC tag" # IdentifierExp at 31.18; stackHeight = 32
             sw $t0,($sp)#**"" # IdentifierExp at 31.18; stackHeight = 32
            # EXIT NODE # IdentifierExp at 31.18; stackHeight = 32
            # ENTER NODE # IdentifierExp at 31.22; stackHeight = 32
             lw $t0,36($sp) # local: stackHt=32,var-offset=4 # IdentifierExp at 31.22; stackHeight = 32
             subu $sp,$sp,8 # IdentifierExp at 31.22; stackHeight = 32
             sw $s5,4($sp)#**"GC tag" # IdentifierExp at 31.22; stackHeight = 40
             sw $t0,($sp)#**"" # IdentifierExp at 31.22; stackHeight = 40
            # EXIT NODE # IdentifierExp at 31.22; stackHeight = 40
           lw $t0,($sp) # LessThan at 31.20; stackHeight = 40
           lw $t1,8($sp) # LessThan at 31.20; stackHeight = 40
           slt $t0,$t1,$t0 # LessThan at 31.20; stackHeight = 40
           addu $sp,$sp,12 # LessThan at 31.20; stackHeight = 40
           sw $t0,($sp)#**"" # LessThan at 31.20; stackHeight = 28
          # EXIT NODE # LessThan at 31.20; stackHeight = 28
         lw $t0,($sp) # While at 31.2; stackHeight = 28
         addu $sp,$sp,4 # While at 31.2; stackHeight = 28
        bne $t0,$zero,while_top_73 # While at 31.2; stackHeight = 24
        break_target_73: # While at 31.2; stackHeight = 24
        # EXIT NODE # While at 31.2; stackHeight = 24
       addu $sp,8 # Block at 31.2; stackHeight = 24
      # EXIT NODE # Block at 31.2; stackHeight = 16
      # ENTER NODE # IdentifierExp at 36.9; stackHeight = 16
       lw $t0,0($sp) # local: stackHt=16,var-offset=-16 # IdentifierExp at 36.9; stackHeight = 16
       subu $sp,$sp,8 # IdentifierExp at 36.9; stackHeight = 16
       sw $s5,4($sp)#**"GC tag" # IdentifierExp at 36.9; stackHeight = 24
       sw $t0,($sp)#**"" # IdentifierExp at 36.9; stackHeight = 24
      # EXIT NODE # IdentifierExp at 36.9; stackHeight = 24
     lw $ra,36($sp) # MethodDeclNonVoid at 28.16; stackHeight = 24
     lw $s2,24($sp) # MethodDeclNonVoid at 28.16; stackHeight = 24
     lw $t0,($sp) # MethodDeclNonVoid at 28.16; stackHeight = 24
     sw $t0,32($sp)#**"(return-val)" # MethodDeclNonVoid at 28.16; stackHeight = 24
     sw $s5,36($sp)#**"" # MethodDeclNonVoid at 28.16; stackHeight = 24
     addu $sp,$sp,32 # MethodDeclNonVoid at 28.16; stackHeight = 24
    jr $ra # MethodDeclNonVoid at 28.16; stackHeight = -8
    # EXIT NODE # MethodDeclNonVoid at 28.16; stackHeight = -8
  # EXIT NODE # ClassDecl at 4.7; stackHeight = -8
##############################################################
