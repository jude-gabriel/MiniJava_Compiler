...
CLASS_Main: # ClassDecl at 5.7
 ...
 .word fcn_35_main # ClassDecl at 5.7
 .word fcn_63_fib # ClassDecl at 5.7
...
strLit_32: # StringLiteral at 24.15
 .text # Program at 5.1; stackHeight = 0
  ...
  # **** class Main **** # ClassDecl at 5.7; stackHeight = 0
    # ENTER NODE # MethodDeclVoid at 8.17; stackHeight = 0
    .globl fcn_35_main # MethodDeclVoid at 8.17; stackHeight = 0
    fcn_35_main: # MethodDeclVoid at 8.17; stackHeight = 0
     subu $sp,$sp,4 # MethodDeclVoid at 8.17; stackHeight = 0
     sw $s2,($sp) #**"old this-ptr" # MethodDeclVoid at 8.17; stackHeight = 0
     lw $s2,4($sp) #**"this-ptr" # MethodDeclVoid at 8.17; stackHeight = 0
     sw $ra,4($sp) #**"RA:main" # MethodDeclVoid at 8.17; stackHeight = 0
      # ENTER NODE # LocalVarDecl at 11.6; stackHeight = 0
        # ENTER NODE # NewObject at 11.12; stackHeight = 0
         li $s6,1 # NewObject at 11.12; stackHeight = 0
         li $s7,0 # NewObject at 11.12; stackHeight = 0
         jal newObject # NewObject at 11.12; stackHeight = 0
         la $t0,CLASS_Lib # NewObject at 11.12; stackHeight = 4
         sw $t0,-12($s7)#**"VTP: Lib" # NewObject at 11.12; stackHeight = 4
        # EXIT NODE # NewObject at 11.12; stackHeight = 4
      # EXIT NODE # LocalVarDecl at 11.6; stackHeight = 4
      # ENTER NODE # LocalVarDecl at 14.6; stackHeight = 4
        # ENTER NODE # IntegerLiteral at 14.12; stackHeight = 4
         subu $sp,$sp,8 # IntegerLiteral at 14.12; stackHeight = 4
         sw $s5,4($sp)#**"GC tag" # IntegerLiteral at 14.12; stackHeight = 12
         li $t0,14 # IntegerLiteral at 14.12; stackHeight = 12
         sw $t0,($sp) # IntegerLiteral at 14.12; stackHeight = 12
        # EXIT NODE # IntegerLiteral at 14.12; stackHeight = 12
      # EXIT NODE # LocalVarDecl at 14.6; stackHeight = 12
      # ENTER NODE # LocalVarDecl at 17.6; stackHeight = 12
        # ENTER NODE # Call at 17.15; stackHeight = 12
          # ENTER NODE # This at 17.15; stackHeight = 12
           subu $sp,$sp,4 # This at 17.15; stackHeight = 12
           sw $s2,($sp)#**"" # This at 17.15; stackHeight = 16
          # EXIT NODE # This at 17.15; stackHeight = 16
          # ENTER NODE # IdentifierExp at 17.19; stackHeight = 16
           lw $t0,4($sp) # local: stackHt=16,var-offset=-12 # IdentifierExp at 17.19; stackHeight = 16
           subu $sp,$sp,8 # IdentifierExp at 17.19; stackHeight = 16
           sw $s5,4($sp)#**"GC tag" # IdentifierExp at 17.19; stackHeight = 24
           sw $t0,($sp)#**"" # IdentifierExp at 17.19; stackHeight = 24
          # EXIT NODE # IdentifierExp at 17.19; stackHeight = 24
         lw $t0,8($sp) # Call at 17.15; stackHeight = 24
         beq $t0,$zero,nullPtrException # Call at 17.15; stackHeight = 24
         lw $t0,-12($t0) # Call at 17.15; stackHeight = 24
         lw $t0,16($t0) # Call at 17.15; stackHeight = 24
         jalr $t0 # fib # Call at 17.15; stackHeight = 24
        # EXIT NODE # Call at 17.15; stackHeight = 20
      # EXIT NODE # LocalVarDecl at 17.6; stackHeight = 20
      # ENTER NODE # CallStatement at 20.6; stackHeight = 20
        # ENTER NODE # Call at 20.6; stackHeight = 20
          ...
          # ENTER NODE # StringLiteral at 20.15; stackHeight = 24
           ...
           la $t0,strLit_16 # StringLiteral at 20.15; stackHeight = 28
           sw $t0,($sp)#**"strLit:The fibonacci number of " # StringLiteral at 20.15; stackHeight = 28
      ...
      # ENTER NODE # CallStatement at 21.6; stackHeight = 20
        # ENTER NODE # Call at 21.6; stackHeight = 20
          ...
          # ENTER NODE # IdentifierExp at 21.15; stackHeight = 24
           lw $t0,12($sp) # local: stackHt=24,var-offset=-12 # IdentifierExp at 21.15; stackHeight = 24
      ...
      # ENTER NODE # CallStatement at 22.6; stackHeight = 20
        # ENTER NODE # Call at 22.6; stackHeight = 20
          ...
          # ENTER NODE # StringLiteral at 22.15; stackHeight = 24
           ...
           la $t0,strLit_24 # StringLiteral at 22.15; stackHeight = 28
           sw $t0,($sp)#**"strLit: is " # StringLiteral at 22.15; stackHeight = 28
      ...
      # ENTER NODE # CallStatement at 23.6; stackHeight = 20
        # ENTER NODE # Call at 23.6; stackHeight = 20
          ...
          # ENTER NODE # IdentifierExp at 23.15; stackHeight = 24
           lw $t0,4($sp) # local: stackHt=24,var-offset=-20 # IdentifierExp at 23.15; stackHeight = 24
           subu $sp,$sp,8 # IdentifierExp at 23.15; stackHeight = 24
           sw $s5,4($sp)#**"GC tag" # IdentifierExp at 23.15; stackHeight = 32
           sw $t0,($sp)#**"" # IdentifierExp at 23.15; stackHeight = 32
          # EXIT NODE # IdentifierExp at 23.15; stackHeight = 32
         lw $t0,8($sp) # Call at 23.6; stackHeight = 32
         beq $t0,$zero,nullPtrException # Call at 23.6; stackHeight = 32
         lw $t0,-12($t0) # Call at 23.6; stackHeight = 32
         lw $t0,32($t0) # Call at 23.6; stackHeight = 32
         jalr $t0 # printInt # Call at 23.6; stackHeight = 32
        # EXIT NODE # Call at 23.6; stackHeight = 20
      # EXIT NODE # CallStatement at 23.6; stackHeight = 20
      # ENTER NODE # CallStatement at 24.6; stackHeight = 20
        # ENTER NODE # Call at 24.6; stackHeight = 20
          # ENTER NODE # IdentifierExp at 24.2; stackHeight = 20
           lw $t0,16($sp) # local: stackHt=20,var-offset=-4 # IdentifierExp at 24.2; stackHeight = 20
           subu $sp,$sp,4 # IdentifierExp at 24.2; stackHeight = 20
           sw $t0,($sp)#**"" # IdentifierExp at 24.2; stackHeight = 24
          # EXIT NODE # IdentifierExp at 24.2; stackHeight = 24
          # ENTER NODE # StringLiteral at 24.15; stackHeight = 24
           subu $sp,$sp,4 # StringLiteral at 24.15; stackHeight = 24
           la $t0,strLit_32 # StringLiteral at 24.15; stackHeight = 28
           sw $t0,($sp)#**"strLit:.\?" # StringLiteral at 24.15; stackHeight = 28
          # EXIT NODE # StringLiteral at 24.15; stackHeight = 28
         lw $t0,4($sp) # Call at 24.6; stackHeight = 28
         beq $t0,$zero,nullPtrException # Call at 24.6; stackHeight = 28
         lw $t0,-12($t0) # Call at 24.6; stackHeight = 28
         lw $t0,24($t0) # Call at 24.6; stackHeight = 28
         jalr $t0 # printStr # Call at 24.6; stackHeight = 28
        # EXIT NODE # Call at 24.6; stackHeight = 20
      # EXIT NODE # CallStatement at 24.6; stackHeight = 20
     # stack height is 20 # MethodDeclVoid at 8.17; stackHeight = 20
     lw $ra,24($sp) # MethodDeclVoid at 8.17; stackHeight = 20
     lw $s2,20($sp) # MethodDeclVoid at 8.17; stackHeight = 20
     addu $sp,$sp,28 # MethodDeclVoid at 8.17; stackHeight = 20
    jr $ra # MethodDeclVoid at 8.17; stackHeight = -8
    # EXIT NODE # MethodDeclVoid at 8.17; stackHeight = -8
    # ENTER NODE # MethodDeclNonVoid at 29.16; stackHeight = -8
    .globl fcn_63_fib # MethodDeclNonVoid at 29.16; stackHeight = -8
    fcn_63_fib: # MethodDeclNonVoid at 29.16; stackHeight = -8
     subu $sp,$sp,4 # MethodDeclNonVoid at 29.16; stackHeight = -8
     sw $s2,($sp) #**"old this-ptr" # MethodDeclNonVoid at 29.16; stackHeight = -8
     lw $s2,12($sp) #**"this-ptr" # MethodDeclNonVoid at 29.16; stackHeight = -8
     sw $ra,12($sp) #**"RA:fib" # MethodDeclNonVoid at 29.16; stackHeight = -8
      # ENTER NODE # LocalVarDecl at 31.6; stackHeight = 0
        # ENTER NODE # IdentifierExp at 31.15; stackHeight = 0
         lw $t0,4($sp) # local: stackHt=0,var-offset=4 # IdentifierExp at 31.15; stackHeight = 0
         subu $sp,$sp,8 # IdentifierExp at 31.15; stackHeight = 0
         sw $s5,4($sp)#**"GC tag" # IdentifierExp at 31.15; stackHeight = 8
         sw $t0,($sp)#**"" # IdentifierExp at 31.15; stackHeight = 8
        # EXIT NODE # IdentifierExp at 31.15; stackHeight = 8
      # EXIT NODE # LocalVarDecl at 31.6; stackHeight = 8
      # ENTER NODE # If at 32.2; stackHeight = 8
        # ENTER NODE # GreaterThan at 32.8; stackHeight = 8
          # ENTER NODE # IdentifierExp at 32.6; stackHeight = 8
           lw $t0,12($sp) # local: stackHt=8,var-offset=4 # IdentifierExp at 32.6; stackHeight = 8
           subu $sp,$sp,8 # IdentifierExp at 32.6; stackHeight = 8
           sw $s5,4($sp)#**"GC tag" # IdentifierExp at 32.6; stackHeight = 16
           sw $t0,($sp)#**"" # IdentifierExp at 32.6; stackHeight = 16
          # EXIT NODE # IdentifierExp at 32.6; stackHeight = 16
          # ENTER NODE # IntegerLiteral at 32.10; stackHeight = 16
           subu $sp,$sp,8 # IntegerLiteral at 32.10; stackHeight = 16
           sw $s5,4($sp)#**"GC tag" # IntegerLiteral at 32.10; stackHeight = 24
           li $t0,1 # IntegerLiteral at 32.10; stackHeight = 24
           sw $t0,($sp) # IntegerLiteral at 32.10; stackHeight = 24
          # EXIT NODE # IntegerLiteral at 32.10; stackHeight = 24
         lw $t0,($sp) # GreaterThan at 32.8; stackHeight = 24
         lw $t1,8($sp) # GreaterThan at 32.8; stackHeight = 24
         sgt $t0,$t1,$t0 # GreaterThan at 32.8; stackHeight = 24
         addu $sp,$sp,12 # GreaterThan at 32.8; stackHeight = 24
         sw $t0,($sp)#**"" # GreaterThan at 32.8; stackHeight = 12
        # EXIT NODE # GreaterThan at 32.8; stackHeight = 12
       lw $t0,($sp) # If at 32.2; stackHeight = 12
       addu $sp,$sp,4 # If at 32.2; stackHeight = 12
       beq $t0,$zero,if_else_61 # If at 32.2; stackHeight = 8
        # ENTER NODE # Block at 32.13; stackHeight = 8
          # ENTER NODE # Assign at 34.13; stackHeight = 8
            # ENTER NODE # Plus at 34.24; stackHeight = 8
              # ENTER NODE # Call at 34.15; stackHeight = 8
                # ENTER NODE # This at 34.15; stackHeight = 8
                 subu $sp,$sp,4 # This at 34.15; stackHeight = 8
                 sw $s2,($sp)#**"" # This at 34.15; stackHeight = 12
                # EXIT NODE # This at 34.15; stackHeight = 12
                # ENTER NODE # Minus at 34.20; stackHeight = 12
                  # ENTER NODE # IdentifierExp at 34.19; stackHeight = 12
                   lw $t0,16($sp) # local: stackHt=12,var-offset=4 # IdentifierExp at 34.19; stackHeight = 12
                   subu $sp,$sp,8 # IdentifierExp at 34.19; stackHeight = 12
                   sw $s5,4($sp)#**"GC tag" # IdentifierExp at 34.19; stackHeight = 20
                   sw $t0,($sp)#**"" # IdentifierExp at 34.19; stackHeight = 20
                  # EXIT NODE # IdentifierExp at 34.19; stackHeight = 20
                  # ENTER NODE # IntegerLiteral at 34.21; stackHeight = 20
                   subu $sp,$sp,8 # IntegerLiteral at 34.21; stackHeight = 20
                   sw $s5,4($sp)#**"GC tag" # IntegerLiteral at 34.21; stackHeight = 28
                   li $t0,1 # IntegerLiteral at 34.21; stackHeight = 28
                   sw $t0,($sp) # IntegerLiteral at 34.21; stackHeight = 28
                  # EXIT NODE # IntegerLiteral at 34.21; stackHeight = 28
                 lw $t0,($sp) # Minus at 34.20; stackHeight = 28
                 lw $t1,8($sp) # Minus at 34.20; stackHeight = 28
                 subu $t0,$t1,$t0 # Minus at 34.20; stackHeight = 28
                 addu $sp,$sp,8 # Minus at 34.20; stackHeight = 28
                 sw $t0,($sp)#**"" # Minus at 34.20; stackHeight = 20
                # EXIT NODE # Minus at 34.20; stackHeight = 20
               lw $t0,8($sp) # Call at 34.15; stackHeight = 20
               beq $t0,$zero,nullPtrException # Call at 34.15; stackHeight = 20
               lw $t0,-12($t0) # Call at 34.15; stackHeight = 20
               lw $t0,16($t0) # Call at 34.15; stackHeight = 20
               jalr $t0 # fib # Call at 34.15; stackHeight = 20
              # EXIT NODE # Call at 34.15; stackHeight = 16
              # ENTER NODE # Call at 34.26; stackHeight = 16
                # ENTER NODE # This at 34.26; stackHeight = 16
                 subu $sp,$sp,4 # This at 34.26; stackHeight = 16
                 sw $s2,($sp)#**"" # This at 34.26; stackHeight = 20
                # EXIT NODE # This at 34.26; stackHeight = 20
                # ENTER NODE # Minus at 34.31; stackHeight = 20
                  # ENTER NODE # IdentifierExp at 34.30; stackHeight = 20
                   lw $t0,24($sp) # local: stackHt=20,var-offset=4 # IdentifierExp at 34.30; stackHeight = 20
                   subu $sp,$sp,8 # IdentifierExp at 34.30; stackHeight = 20
                   sw $s5,4($sp)#**"GC tag" # IdentifierExp at 34.30; stackHeight = 28
                   sw $t0,($sp)#**"" # IdentifierExp at 34.30; stackHeight = 28
                  # EXIT NODE # IdentifierExp at 34.30; stackHeight = 28
                  # ENTER NODE # IntegerLiteral at 34.32; stackHeight = 28
                   subu $sp,$sp,8 # IntegerLiteral at 34.32; stackHeight = 28
                   sw $s5,4($sp)#**"GC tag" # IntegerLiteral at 34.32; stackHeight = 36
                   li $t0,2 # IntegerLiteral at 34.32; stackHeight = 36
                   sw $t0,($sp) # IntegerLiteral at 34.32; stackHeight = 36
                  # EXIT NODE # IntegerLiteral at 34.32; stackHeight = 36
                 lw $t0,($sp) # Minus at 34.31; stackHeight = 36
                 lw $t1,8($sp) # Minus at 34.31; stackHeight = 36
                 subu $t0,$t1,$t0 # Minus at 34.31; stackHeight = 36
                 addu $sp,$sp,8 # Minus at 34.31; stackHeight = 36
                 sw $t0,($sp)#**"" # Minus at 34.31; stackHeight = 28
                # EXIT NODE # Minus at 34.31; stackHeight = 28
               lw $t0,8($sp) # Call at 34.26; stackHeight = 28
               beq $t0,$zero,nullPtrException # Call at 34.26; stackHeight = 28
               lw $t0,-12($t0) # Call at 34.26; stackHeight = 28
               lw $t0,16($t0) # Call at 34.26; stackHeight = 28
               jalr $t0 # fib # Call at 34.26; stackHeight = 28
              # EXIT NODE # Call at 34.26; stackHeight = 24
             lw $t0,($sp) # Plus at 34.24; stackHeight = 24
             lw $t1,8($sp) # Plus at 34.24; stackHeight = 24
             addu $t0,$t0,$t1 # Plus at 34.24; stackHeight = 24
             addu $sp,$sp,8 # Plus at 34.24; stackHeight = 24
             sw $t0,($sp)#**"" # Plus at 34.24; stackHeight = 24
            # EXIT NODE # Plus at 34.24; stackHeight = 16
           lw $t0,($sp) # Assign at 34.13; stackHeight = 16
           sw $t0,8($sp) # Assign at 34.13; stackHeight = 16
           addu $sp,$sp,8 # Assign at 34.13; stackHeight = 16
          # EXIT NODE # Assign at 34.13; stackHeight = 8
        # EXIT NODE # Block at 32.13; stackHeight = 8
      j if_done_61 # If at 32.2; stackHeight = 8
      if_else_61: # If at 32.2; stackHeight = 8
        # ENTER NODE # Block at 36.2; stackHeight = 8
        # EXIT NODE # Block at 36.2; stackHeight = 8
      if_done_61: # If at 32.2; stackHeight = 8
      # EXIT NODE # If at 32.2; stackHeight = 8
      # ENTER NODE # IdentifierExp at 36.9; stackHeight = 8
       lw $t0,0($sp) # local: stackHt=8,var-offset=-8 # IdentifierExp at 36.9; stackHeight = 8
       subu $sp,$sp,8 # IdentifierExp at 36.9; stackHeight = 8
       sw $s5,4($sp)#**"GC tag" # IdentifierExp at 36.9; stackHeight = 16
       sw $t0,($sp)#**"" # IdentifierExp at 36.9; stackHeight = 16
      # EXIT NODE # IdentifierExp at 36.9; stackHeight = 16
     lw $ra,28($sp) # MethodDeclNonVoid at 29.16; stackHeight = 16
     lw $s2,16($sp) # MethodDeclNonVoid at 29.16; stackHeight = 16
     lw $t0,($sp) # MethodDeclNonVoid at 29.16; stackHeight = 16
     sw $t0,24($sp)#**"(return-val)" # MethodDeclNonVoid at 29.16; stackHeight = 16
     sw $s5,28($sp)#**"" # MethodDeclNonVoid at 29.16; stackHeight = 16
     addu $sp,$sp,24 # MethodDeclNonVoid at 29.16; stackHeight = 16
    jr $ra # MethodDeclNonVoid at 29.16; stackHeight = -8
    # EXIT NODE # MethodDeclNonVoid at 29.16; stackHeight = -8
