...
# ****** class Main ****** # ClassDecl at 2.7
 .byte 205 # 'M' with high bit set # IdentifierType at 2.7
 .byte 97 # 'a' # IdentifierType at 2.7
 .byte 105 # 'i' # IdentifierType at 2.7
 .byte 110 # 'n' # IdentifierType at 2.7
CLASS_Main: # ClassDecl at 2.7
 .word hashCode_Object # ClassDecl at 2.7
 .word equals_Object # ClassDecl at 2.7
 .word toString_Object # ClassDecl at 2.7
 .word readLine_Lib # ClassDecl at 2.7
 .word readInt_Lib # ClassDecl at 2.7
 .word readChar_Lib # ClassDecl at 2.7
 .word printStr_Lib # ClassDecl at 2.7
 .word printBool_Lib # ClassDecl at 2.7
 .word printInt_Lib # ClassDecl at 2.7
 .word intToString_Lib # ClassDecl at 2.7
 .word intToChar_Lib # ClassDecl at 2.7
 .word fcn_30_main # ClassDecl at 2.7
...
strLit_22: # StringLiteral at 7.21
 .text # Program at 2.1; stackHeight = 0
  # ENTER NODE # Program at 2.1; stackHeight = 0
   .globl main # Program at 2.1; stackHeight = 0
  main: # Program at 2.1; stackHeight = 0
   jal vm_init # Program at 2.1; stackHeight = 0
   ...
   li $v0,10 # Program at 2.1; stackHeight = 0
   syscall # Program at 2.1; stackHeight = 0
  # EXIT NODE # Program at 2.1; stackHeight = 0
  # ENTER NODE # ClassDecl at 2.7; stackHeight = 0
  # **** class Main **** # ClassDecl at 2.7; stackHeight = 0
    # ENTER NODE # MethodDeclVoid at 3.17; stackHeight = 0
    .globl fcn_30_main # MethodDeclVoid at 3.17; stackHeight = 0
    fcn_30_main: # MethodDeclVoid at 3.17; stackHeight = 0
     subu $sp,$sp,4 # MethodDeclVoid at 3.17; stackHeight = 0
     sw $s2,($sp) #**"old this-ptr" # MethodDeclVoid at 3.17; stackHeight = 0
     lw $s2,4($sp) #**"this-ptr" # MethodDeclVoid at 3.17; stackHeight = 0
     sw $ra,4($sp) #**"RA:main" # MethodDeclVoid at 3.17; stackHeight = 0
      # ENTER NODE # Block at 4.2; stackHeight = 0
        # ENTER NODE # LocalVarDecl at 4.11; stackHeight = 0
          # ENTER NODE # IntegerLiteral at 4.15; stackHeight = 0
           subu $sp,$sp,8 # IntegerLiteral at 4.15; stackHeight = 0
           sw $s5,4($sp)#**"GC tag" # IntegerLiteral at 4.15; stackHeight = 8
           li $t0,0 # IntegerLiteral at 4.15; stackHeight = 8
           sw $t0,($sp) # IntegerLiteral at 4.15; stackHeight = 8
          # EXIT NODE # IntegerLiteral at 4.15; stackHeight = 8
        # EXIT NODE # LocalVarDecl at 4.11; stackHeight = 8
        # ENTER NODE # While at 4.2; stackHeight = 8
        j while_enter_28 # While at 4.2; stackHeight = 8
        while_top_28: # While at 4.2; stackHeight = 8
          # ENTER NODE # Block at 4.2; stackHeight = 8
            # ENTER NODE # Block at 4.31; stackHeight = 8
              # ENTER NODE # If at 5.6; stackHeight = 8
                # ENTER NODE # Equals at 5.12; stackHeight = 8
                  # ENTER NODE # IdentifierExp at 5.10; stackHeight = 8
                   lw $t0,0($sp) # local: stackHt=8,var-offset=-8 # IdentifierExp at 5.10; stackHeight = 8
                   subu $sp,$sp,8 # IdentifierExp at 5.10; stackHeight = 8
                   sw $s5,4($sp)#**"GC tag" # IdentifierExp at 5.10; stackHeight = 16
                   sw $t0,($sp)#**"" # IdentifierExp at 5.10; stackHeight = 16
                  # EXIT NODE # IdentifierExp at 5.10; stackHeight = 16
                  # ENTER NODE # IntegerLiteral at 5.15; stackHeight = 16
                   subu $sp,$sp,8 # IntegerLiteral at 5.15; stackHeight = 16
                   sw $s5,4($sp)#**"GC tag" # IntegerLiteral at 5.15; stackHeight = 24
                   li $t0,12 # IntegerLiteral at 5.15; stackHeight = 24
                   sw $t0,($sp) # IntegerLiteral at 5.15; stackHeight = 24
                  # EXIT NODE # IntegerLiteral at 5.15; stackHeight = 24
                 lw $t0,($sp) # Equals at 5.12; stackHeight = 24
                 lw $t1,8($sp) # Equals at 5.12; stackHeight = 24
                 seq $t0,$t0,$t1 # Equals at 5.12; stackHeight = 24
                 addu $sp,$sp,12 # Equals at 5.12; stackHeight = 24
                 sw $t0,($sp)#**"" # Equals at 5.12; stackHeight = 12
                # EXIT NODE # Equals at 5.12; stackHeight = 12
               lw $t0,($sp) # If at 5.6; stackHeight = 12
               addu $sp,$sp,4 # If at 5.6; stackHeight = 12
               beq $t0,$zero,if_else_17 # If at 5.6; stackHeight = 8
                # ENTER NODE # Break at 5.19; stackHeight = 8
                j break_target_28 # Break at 5.19; stackHeight = 8
                # EXIT NODE # Break at 5.19; stackHeight = 8
              j if_done_17 # If at 5.6; stackHeight = 8
              if_else_17: # If at 5.6; stackHeight = 8
                # ENTER NODE # Block at 6.6; stackHeight = 8
                # EXIT NODE # Block at 6.6; stackHeight = 8
              if_done_17: # If at 5.6; stackHeight = 8
              # EXIT NODE # If at 5.6; stackHeight = 8
              # ENTER NODE # CallStatement at 6.12; stackHeight = 8
                # ENTER NODE # Call at 6.12; stackHeight = 8
                  # ENTER NODE # Super at 6.12; stackHeight = 8
                   subu $sp,$sp,4 # Super at 6.12; stackHeight = 8
                   sw $s2,($sp)#**"" # Super at 6.12; stackHeight = 12
                  # EXIT NODE # Super at 6.12; stackHeight = 12
                  # ENTER NODE # IdentifierExp at 6.21; stackHeight = 12
                   lw $t0,4($sp) # local: stackHt=12,var-offset=-8 # IdentifierExp at 6.21; stackHeight = 12
                   subu $sp,$sp,8 # IdentifierExp at 6.21; stackHeight = 12
                   sw $s5,4($sp)#**"GC tag" # IdentifierExp at 6.21; stackHeight = 20
                   sw $t0,($sp)#**"" # IdentifierExp at 6.21; stackHeight = 20
                  # EXIT NODE # IdentifierExp at 6.21; stackHeight = 20
                 jal printInt_Lib # printInt # Call at 6.12; stackHeight = 20
                # EXIT NODE # Call at 6.12; stackHeight = 8
              # EXIT NODE # CallStatement at 6.12; stackHeight = 8
              # ENTER NODE # CallStatement at 7.12; stackHeight = 8
                # ENTER NODE # Call at 7.12; stackHeight = 8
                  # ENTER NODE # Super at 7.12; stackHeight = 8
                   subu $sp,$sp,4 # Super at 7.12; stackHeight = 8
                   sw $s2,($sp)#**"" # Super at 7.12; stackHeight = 12
                  # EXIT NODE # Super at 7.12; stackHeight = 12
                  # ENTER NODE # StringLiteral at 7.21; stackHeight = 12
                   subu $sp,$sp,4 # StringLiteral at 7.21; stackHeight = 12
                   la $t0,strLit_22 # StringLiteral at 7.21; stackHeight = 16
                   sw $t0,($sp)#**"strLit:\?" # StringLiteral at 7.21; stackHeight = 16
                  # EXIT NODE # StringLiteral at 7.21; stackHeight = 16
                 jal printStr_Lib # printStr # Call at 7.12; stackHeight = 16
                # EXIT NODE # Call at 7.12; stackHeight = 8
              # EXIT NODE # CallStatement at 7.12; stackHeight = 8
            # EXIT NODE # Block at 4.31; stackHeight = 8
            # ENTER NODE # Assign at 4.26; stackHeight = 8
              # ENTER NODE # Plus at 4.27; stackHeight = 8
                # ENTER NODE # IdentifierExp at 4.26; stackHeight = 8
                 lw $t0,0($sp) # local: stackHt=8,var-offset=-8 # IdentifierExp at 4.26; stackHeight = 8
                 subu $sp,$sp,8 # IdentifierExp at 4.26; stackHeight = 8
                 sw $s5,4($sp)#**"GC tag" # IdentifierExp at 4.26; stackHeight = 16
                 sw $t0,($sp)#**"" # IdentifierExp at 4.26; stackHeight = 16
                # EXIT NODE # IdentifierExp at 4.26; stackHeight = 16
                # ENTER NODE # IntegerLiteral at 4.27; stackHeight = 16
                 subu $sp,$sp,8 # IntegerLiteral at 4.27; stackHeight = 16
                 sw $s5,4($sp)#**"GC tag" # IntegerLiteral at 4.27; stackHeight = 24
                 li $t0,1 # IntegerLiteral at 4.27; stackHeight = 24
                 sw $t0,($sp) # IntegerLiteral at 4.27; stackHeight = 24
                # EXIT NODE # IntegerLiteral at 4.27; stackHeight = 24
               lw $t0,($sp) # Plus at 4.27; stackHeight = 24
               lw $t1,8($sp) # Plus at 4.27; stackHeight = 24
               addu $t0,$t0,$t1 # Plus at 4.27; stackHeight = 24
               addu $sp,$sp,8 # Plus at 4.27; stackHeight = 24
               sw $t0,($sp)#**"" # Plus at 4.27; stackHeight = 24
              # EXIT NODE # Plus at 4.27; stackHeight = 16
             lw $t0,($sp) # Assign at 4.26; stackHeight = 16
             sw $t0,8($sp) # Assign at 4.26; stackHeight = 16
             addu $sp,$sp,8 # Assign at 4.26; stackHeight = 16
            # EXIT NODE # Assign at 4.26; stackHeight = 8
          # EXIT NODE # Block at 4.2; stackHeight = 8
        while_enter_28: # While at 4.2; stackHeight = 8
          # ENTER NODE # LessThan at 4.20; stackHeight = 8
            # ENTER NODE # IdentifierExp at 4.18; stackHeight = 8
             lw $t0,0($sp) # local: stackHt=8,var-offset=-8 # IdentifierExp at 4.18; stackHeight = 8
             subu $sp,$sp,8 # IdentifierExp at 4.18; stackHeight = 8
             sw $s5,4($sp)#**"GC tag" # IdentifierExp at 4.18; stackHeight = 16
             sw $t0,($sp)#**"" # IdentifierExp at 4.18; stackHeight = 16
            # EXIT NODE # IdentifierExp at 4.18; stackHeight = 16
            # ENTER NODE # IntegerLiteral at 4.22; stackHeight = 16
             subu $sp,$sp,8 # IntegerLiteral at 4.22; stackHeight = 16
             sw $s5,4($sp)#**"GC tag" # IntegerLiteral at 4.22; stackHeight = 24
             li $t0,20 # IntegerLiteral at 4.22; stackHeight = 24
             sw $t0,($sp) # IntegerLiteral at 4.22; stackHeight = 24
            # EXIT NODE # IntegerLiteral at 4.22; stackHeight = 24
           lw $t0,($sp) # LessThan at 4.20; stackHeight = 24
           lw $t1,8($sp) # LessThan at 4.20; stackHeight = 24
           slt $t0,$t1,$t0 # LessThan at 4.20; stackHeight = 24
           addu $sp,$sp,12 # LessThan at 4.20; stackHeight = 24
           sw $t0,($sp)#**"" # LessThan at 4.20; stackHeight = 12
          # EXIT NODE # LessThan at 4.20; stackHeight = 12
         lw $t0,($sp) # While at 4.2; stackHeight = 12
         addu $sp,$sp,4 # While at 4.2; stackHeight = 12
        bne $t0,$zero,while_top_28 # While at 4.2; stackHeight = 8
        break_target_28: # While at 4.2; stackHeight = 8
        # EXIT NODE # While at 4.2; stackHeight = 8
       addu $sp,8 # Block at 4.2; stackHeight = 8
      # EXIT NODE # Block at 4.2; stackHeight = 0
     # stack height is 0 # MethodDeclVoid at 3.17; stackHeight = 0
     lw $ra,4($sp) # MethodDeclVoid at 3.17; stackHeight = 0
     lw $s2,0($sp) # MethodDeclVoid at 3.17; stackHeight = 0
     addu $sp,$sp,8 # MethodDeclVoid at 3.17; stackHeight = 0
    jr $ra # MethodDeclVoid at 3.17; stackHeight = -8
    # EXIT NODE # MethodDeclVoid at 3.17; stackHeight = -8
  # EXIT NODE # ClassDecl at 2.7; stackHeight = -8
##############################################################
