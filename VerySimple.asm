  ...
  # **** class Main **** # ClassDecl at 3.7; stackHeight = 0
    ...
    fcn_4_main: # MethodDeclVoid at 4.17; stackHeight = 0
     ...
     sw $ra,4($sp) #**"RA:main" # MethodDeclVoid at 4.17; stackHeight = 0
      # ENTER NODE # CallStatement at 5.8; stackHeight = 0
        # ENTER NODE # Call at 5.8; stackHeight = 0
          # ENTER NODE # Super at 5.8; stackHeight = 0
           subu $sp,$sp,4 # Super at 5.8; stackHeight = 0
           sw $s2,($sp)#**"" # Super at 5.8; stackHeight = 4
          # EXIT NODE # Super at 5.8; stackHeight = 4
          # ENTER NODE # IntegerLiteral at 5.17; stackHeight = 4
           subu $sp,$sp,8 # IntegerLiteral at 5.17; stackHeight = 4
           sw $s5,4($sp)#**"GC tag" # IntegerLiteral at 5.17; stackHeight = 12
           li $t0,3 # IntegerLiteral at 5.17; stackHeight = 12
           sw $t0,($sp) # IntegerLiteral at 5.17; stackHeight = 12
          # EXIT NODE # IntegerLiteral at 5.17; stackHeight = 12
         jal printInt_Lib # printInt # Call at 5.8; stackHeight = 12
        # EXIT NODE # Call at 5.8; stackHeight = 0
      # EXIT NODE # CallStatement at 5.8; stackHeight = 0
