...
# ****** class Vehicle ****** # ClassDecl at 14.7
 .byte 0 # IdentifierType at 14.7
 .byte 214 # 'V' with high bit set # IdentifierType at 14.7
 .byte 101 # 'e' # IdentifierType at 14.7
 .byte 104 # 'h' # IdentifierType at 14.7
 .byte 105 # 'i' # IdentifierType at 14.7
 .byte 99 # 'c' # IdentifierType at 14.7
 .byte 108 # 'l' # IdentifierType at 14.7
 .byte 101 # 'e' # IdentifierType at 14.7
CLASS_Vehicle: # ClassDecl at 14.7
 .word hashCode_Object # ClassDecl at 14.7
 .word equals_Object # ClassDecl at 14.7
 .word toString_Object # ClassDecl at 14.7
 .word fcn_32_price # ClassDecl at 14.7
# ****** class Car ****** # ClassDecl at 20.7
 .byte 0 # IdentifierType at 20.7
 .byte 195 # 'C' with high bit set # IdentifierType at 20.7
 .byte 97 # 'a' # IdentifierType at 20.7
 .byte 114 # 'r' # IdentifierType at 20.7
CLASS_Car: # ClassDecl at 20.7
 .word hashCode_Object # ClassDecl at 20.7
 .word equals_Object # ClassDecl at 20.7
 .word toString_Object # ClassDecl at 20.7
 .word fcn_36_price # ClassDecl at 20.7
...
CLASS_Main: # ClassDecl at 3.7
 ...
 .word fcn_28_main # ClassDecl at 3.7
...
strLit_24: # StringLiteral at 10.18
 .text # Program at 3.1; stackHeight = 0
  ...
  # **** class Main **** # ClassDecl at 3.7; stackHeight = 0
    # ENTER NODE # MethodDeclVoid at 4.14; stackHeight = 0
    .globl fcn_28_main # MethodDeclVoid at 4.14; stackHeight = 0
    fcn_28_main: # MethodDeclVoid at 4.14; stackHeight = 0
     subu $sp,$sp,4 # MethodDeclVoid at 4.14; stackHeight = 0
     sw $s2,($sp) #**"old this-ptr" # MethodDeclVoid at 4.14; stackHeight = 0
     lw $s2,4($sp) #**"this-ptr" # MethodDeclVoid at 4.14; stackHeight = 0
     sw $ra,4($sp) #**"RA:main" # MethodDeclVoid at 4.14; stackHeight = 0
      # ENTER NODE # LocalVarDecl at 5.11; stackHeight = 0
        # ENTER NODE # NewObject at 5.16; stackHeight = 0
         li $s6,1 # NewObject at 5.16; stackHeight = 0
         li $s7,0 # NewObject at 5.16; stackHeight = 0
         jal newObject # NewObject at 5.16; stackHeight = 0
         la $t0,CLASS_Car # NewObject at 5.16; stackHeight = 4
         sw $t0,-12($s7)#**"VTP: Car" # NewObject at 5.16; stackHeight = 4
        # EXIT NODE # NewObject at 5.16; stackHeight = 4
      # EXIT NODE # LocalVarDecl at 5.11; stackHeight = 4
      # ENTER NODE # LocalVarDecl at 6.11; stackHeight = 4
        # ENTER NODE # NewObject at 6.16; stackHeight = 4
         li $s6,1 # NewObject at 6.16; stackHeight = 4
         li $s7,0 # NewObject at 6.16; stackHeight = 4
         jal newObject # NewObject at 6.16; stackHeight = 4
         la $t0,CLASS_Vehicle # NewObject at 6.16; stackHeight = 8
         sw $t0,-12($s7)#**"VTP: Vehicle" # NewObject at 6.16; stackHeight = 8
        # EXIT NODE # NewObject at 6.16; stackHeight = 8
      # EXIT NODE # LocalVarDecl at 6.11; stackHeight = 8
      # ENTER NODE # CallStatement at 7.9; stackHeight = 8
        # ENTER NODE # Call at 7.9; stackHeight = 8
          # ENTER NODE # Super at 7.9; stackHeight = 8
           subu $sp,$sp,4 # Super at 7.9; stackHeight = 8
           sw $s2,($sp)#**"" # Super at 7.9; stackHeight = 12
          # EXIT NODE # Super at 7.9; stackHeight = 12
          # ENTER NODE # Call at 7.21; stackHeight = 12
            # ENTER NODE # IdentifierExp at 7.18; stackHeight = 12
             lw $t0,8($sp) # local: stackHt=12,var-offset=-4 # IdentifierExp at 7.18; stackHeight = 12
             subu $sp,$sp,4 # IdentifierExp at 7.18; stackHeight = 12
             sw $t0,($sp)#**"" # IdentifierExp at 7.18; stackHeight = 16
            # EXIT NODE # IdentifierExp at 7.18; stackHeight = 16
           lw $t0,0($sp) # Call at 7.21; stackHeight = 16
           beq $t0,$zero,nullPtrException # Call at 7.21; stackHeight = 16
           lw $t0,-12($t0) # Call at 7.21; stackHeight = 16
           lw $t0,12($t0) # Call at 7.21; stackHeight = 16
           jalr $t0 # price # Call at 7.21; stackHeight = 16
          # EXIT NODE # Call at 7.21; stackHeight = 20
         jal printInt_Lib # printInt # Call at 7.9; stackHeight = 20
        # EXIT NODE # Call at 7.9; stackHeight = 8
      # EXIT NODE # CallStatement at 7.9; stackHeight = 8
      # ENTER NODE # CallStatement at 8.9; stackHeight = 8
        # ENTER NODE # Call at 8.9; stackHeight = 8
          # ENTER NODE # Super at 8.9; stackHeight = 8
           subu $sp,$sp,4 # Super at 8.9; stackHeight = 8
           sw $s2,($sp)#**"" # Super at 8.9; stackHeight = 12
          # EXIT NODE # Super at 8.9; stackHeight = 12
          # ENTER NODE # StringLiteral at 8.18; stackHeight = 12
           subu $sp,$sp,4 # StringLiteral at 8.18; stackHeight = 12
           la $t0,strLit_15 # StringLiteral at 8.18; stackHeight = 16
           sw $t0,($sp)#**"strLit: " # StringLiteral at 8.18; stackHeight = 16
          # EXIT NODE # StringLiteral at 8.18; stackHeight = 16
         jal printStr_Lib # printStr # Call at 8.9; stackHeight = 16
        # EXIT NODE # Call at 8.9; stackHeight = 8
      # EXIT NODE # CallStatement at 8.9; stackHeight = 8
      # ENTER NODE # CallStatement at 9.9; stackHeight = 8
        # ENTER NODE # Call at 9.9; stackHeight = 8
          # ENTER NODE # Super at 9.9; stackHeight = 8
           subu $sp,$sp,4 # Super at 9.9; stackHeight = 8
           sw $s2,($sp)#**"" # Super at 9.9; stackHeight = 12
          # EXIT NODE # Super at 9.9; stackHeight = 12
          # ENTER NODE # Call at 9.21; stackHeight = 12
            # ENTER NODE # IdentifierExp at 9.18; stackHeight = 12
             lw $t0,4($sp) # local: stackHt=12,var-offset=-8 # IdentifierExp at 9.18; stackHeight = 12
             subu $sp,$sp,4 # IdentifierExp at 9.18; stackHeight = 12
             sw $t0,($sp)#**"" # IdentifierExp at 9.18; stackHeight = 16
            # EXIT NODE # IdentifierExp at 9.18; stackHeight = 16
           lw $t0,0($sp) # Call at 9.21; stackHeight = 16
           beq $t0,$zero,nullPtrException # Call at 9.21; stackHeight = 16
           lw $t0,-12($t0) # Call at 9.21; stackHeight = 16
           lw $t0,12($t0) # Call at 9.21; stackHeight = 16
           jalr $t0 # price # Call at 9.21; stackHeight = 16
          # EXIT NODE # Call at 9.21; stackHeight = 20
         jal printInt_Lib # printInt # Call at 9.9; stackHeight = 20
        # EXIT NODE # Call at 9.9; stackHeight = 8
      # EXIT NODE # CallStatement at 9.9; stackHeight = 8
      # ENTER NODE # CallStatement at 10.9; stackHeight = 8
        # ENTER NODE # Call at 10.9; stackHeight = 8
          # ENTER NODE # Super at 10.9; stackHeight = 8
           subu $sp,$sp,4 # Super at 10.9; stackHeight = 8
           sw $s2,($sp)#**"" # Super at 10.9; stackHeight = 12
          # EXIT NODE # Super at 10.9; stackHeight = 12
          # ENTER NODE # StringLiteral at 10.18; stackHeight = 12
           subu $sp,$sp,4 # StringLiteral at 10.18; stackHeight = 12
           la $t0,strLit_24 # StringLiteral at 10.18; stackHeight = 16
           sw $t0,($sp)#**"strLit:\?" # StringLiteral at 10.18; stackHeight = 16
          # EXIT NODE # StringLiteral at 10.18; stackHeight = 16
         jal printStr_Lib # printStr # Call at 10.9; stackHeight = 16
        # EXIT NODE # Call at 10.9; stackHeight = 8
      # EXIT NODE # CallStatement at 10.9; stackHeight = 8
     # stack height is 8 # MethodDeclVoid at 4.14; stackHeight = 8
     lw $ra,12($sp) # MethodDeclVoid at 4.14; stackHeight = 8
     lw $s2,8($sp) # MethodDeclVoid at 4.14; stackHeight = 8
     addu $sp,$sp,16 # MethodDeclVoid at 4.14; stackHeight = 8
    jr $ra # MethodDeclVoid at 4.14; stackHeight = -8
    # EXIT NODE # MethodDeclVoid at 4.14; stackHeight = -8
  # EXIT NODE # ClassDecl at 3.7; stackHeight = -8
  # ENTER NODE # ClassDecl at 14.7; stackHeight = -8
  # **** class Vehicle **** # ClassDecl at 14.7; stackHeight = -8
    # ENTER NODE # MethodDeclNonVoid at 15.13; stackHeight = -8
    .globl fcn_32_price # MethodDeclNonVoid at 15.13; stackHeight = -8
    fcn_32_price: # MethodDeclNonVoid at 15.13; stackHeight = -8
     subu $sp,$sp,4 # MethodDeclNonVoid at 15.13; stackHeight = -8
     sw $s2,($sp) #**"old this-ptr" # MethodDeclNonVoid at 15.13; stackHeight = -8
     lw $s2,4($sp) #**"this-ptr" # MethodDeclNonVoid at 15.13; stackHeight = -8
     sw $ra,4($sp) #**"RA:price" # MethodDeclNonVoid at 15.13; stackHeight = -8
      # ENTER NODE # IntegerLiteral at 16.10; stackHeight = 0
       subu $sp,$sp,8 # IntegerLiteral at 16.10; stackHeight = 0
       sw $s5,4($sp)#**"GC tag" # IntegerLiteral at 16.10; stackHeight = 8
       li $t0,100 # IntegerLiteral at 16.10; stackHeight = 8
       sw $t0,($sp) # IntegerLiteral at 16.10; stackHeight = 8
      # EXIT NODE # IntegerLiteral at 16.10; stackHeight = 8
     lw $ra,12($sp) # MethodDeclNonVoid at 15.13; stackHeight = 8
     lw $s2,8($sp) # MethodDeclNonVoid at 15.13; stackHeight = 8
     lw $t0,($sp) # MethodDeclNonVoid at 15.13; stackHeight = 8
     sw $t0,8($sp)#**"(return-val)" # MethodDeclNonVoid at 15.13; stackHeight = 8
     sw $s5,12($sp)#**"" # MethodDeclNonVoid at 15.13; stackHeight = 8
     addu $sp,$sp,8 # MethodDeclNonVoid at 15.13; stackHeight = 8
    jr $ra # MethodDeclNonVoid at 15.13; stackHeight = 0
    # EXIT NODE # MethodDeclNonVoid at 15.13; stackHeight = 0
  # EXIT NODE # ClassDecl at 14.7; stackHeight = 0
  # ENTER NODE # ClassDecl at 20.7; stackHeight = 0
  # **** class Car **** # ClassDecl at 20.7; stackHeight = 0
    # ENTER NODE # MethodDeclNonVoid at 21.13; stackHeight = 0
    .globl fcn_36_price # MethodDeclNonVoid at 21.13; stackHeight = 0
    fcn_36_price: # MethodDeclNonVoid at 21.13; stackHeight = 0
     subu $sp,$sp,4 # MethodDeclNonVoid at 21.13; stackHeight = 0
     sw $s2,($sp) #**"old this-ptr" # MethodDeclNonVoid at 21.13; stackHeight = 0
     lw $s2,4($sp) #**"this-ptr" # MethodDeclNonVoid at 21.13; stackHeight = 0
     sw $ra,4($sp) #**"RA:price" # MethodDeclNonVoid at 21.13; stackHeight = 0
      # ENTER NODE # IntegerLiteral at 22.10; stackHeight = 0
       subu $sp,$sp,8 # IntegerLiteral at 22.10; stackHeight = 0
       sw $s5,4($sp)#**"GC tag" # IntegerLiteral at 22.10; stackHeight = 8
       li $t0,200 # IntegerLiteral at 22.10; stackHeight = 8
       sw $t0,($sp) # IntegerLiteral at 22.10; stackHeight = 8
      # EXIT NODE # IntegerLiteral at 22.10; stackHeight = 8
     lw $ra,12($sp) # MethodDeclNonVoid at 21.13; stackHeight = 8
     lw $s2,8($sp) # MethodDeclNonVoid at 21.13; stackHeight = 8
     lw $t0,($sp) # MethodDeclNonVoid at 21.13; stackHeight = 8
     sw $t0,8($sp)#**"(return-val)" # MethodDeclNonVoid at 21.13; stackHeight = 8
     sw $s5,12($sp)#**"" # MethodDeclNonVoid at 21.13; stackHeight = 8
     addu $sp,$sp,8 # MethodDeclNonVoid at 21.13; stackHeight = 8
    jr $ra # MethodDeclNonVoid at 21.13; stackHeight = 0
    # EXIT NODE # MethodDeclNonVoid at 21.13; stackHeight = 0
  # EXIT NODE # ClassDecl at 20.7; stackHeight = 0
##############################################################
